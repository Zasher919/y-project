<template>
  <div class="app-container" v-loading="loading">
    ...
    >
      ...
      <el-form-item label="产品价格" prop="intro">
      ...
      <el-form-item label="标题" prop="intro">
...
export default {
  ...
  methods: {
    ...
    // 获取  query 参数
    getQuery() {
      console.log('uploadApi', this.uploadApi)
    ...
    onRemoveChange(file) {
      ...
      let index = this.formData.pic.indexOf(res.realUrl)
