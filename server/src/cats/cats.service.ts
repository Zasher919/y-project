...
export class CatsService {
  ...
  async wxlogin(data: any): Promise<any> {
    ...
    const url = `https://api.weixin.qq.com/sns/jscode2session?appid=wxd4c6356695a9c536&secret=4c57f69e64ab18dfc671be961a602b00&js_code=${data.code}&grant_type=authorization_code";`
