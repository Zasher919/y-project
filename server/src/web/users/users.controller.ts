...
export class UsersController {
  ...
  async remove(@Body() removeUserDto: RemoveUserDto, @Request() req): Promise<any> {
    Log({ req })
  ...
  async update(@Param() params: RetrieveUserDto, @Body() updateUserDto: UpdateUserDto): Promise<any> {
  ...
  async updatePassword(@Param() params: RetrieveUserDto, @Body() updataUserPasswordDto: UpdataUserPasswordDto): Promise<any> {
  ...
  async updateAvatar(@Param() params: RetrieveUserDto, @Body() updateUserAvatar: UpdataUserAvatarDto): Promise<any> {
