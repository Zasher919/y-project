...
export class ProductsController {
  ...
  async remove(@Body() removeProductDto: RemoveProductDto, @Request() req): Promise<any> {
    Log({ req })
  ...
  async update(@Param() params: RetrieveProductDto, @Body() updateProductDto: UpdateProductDto): Promise<any> {
