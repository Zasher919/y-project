...
export class AboutController {
  ...
  async remove(@Body() removeAboutDto: RemoveAboutDto, @Request() req): Promise<any> {
    Log({ req })
  ...
  async update(@Param() params: RetrieveAboutDto, @Body() updateAboutDto: UpdateAboutDto): Promise<any> {
