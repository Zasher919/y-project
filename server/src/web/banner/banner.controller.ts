import { Controller, Post, Body, UseGuards, Request, Get, Delete, Put, Param, Query, Logger } from '@nestjs/common'
...
export class BannerController {
  ...
  async remove(@Body() removeBannerDto: RemoveBannerDto, @Request() req): Promise<any> {
    Log({ req })
  ...
  async update(@Param() params: RetrieveBannerDto, @Body() updateBannerDto: UpdateBannerDto): Promise<any> {
