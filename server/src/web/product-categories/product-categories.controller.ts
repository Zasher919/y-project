import { Controller, Post, Body, UseGuards, Request, Get, Delete, Put, Param, Query } from '@nestjs/common'
...
export class ProductCategoriesController {
  ...
  async create(@Body() createProductCategoriesDto: CreateProductCategoriesDto): Promise<ProductCategories> {
  ...
  async remove(@Body() removeProductCategoriesDto: RemoveProductCategoriesDto, @Request() req): Promise<any> {
    Log({ req })
  ...
  async update(@Param() params: RetrieveProductCategoriesDto, @Body() updateProductCategoriesDto: UpdateProductCategoriesDto): Promise<any> {
  ...
  async findAll(@Query() query: FindProductCategoriesDto): Promise<ProductCategories> {
  ...
  async findOneById(@Param() params: RetrieveProductCategoriesDto): Promise<any> {
